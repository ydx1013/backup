...
// @description CSDN、github.io、xz577.com、iteye.com、720ui.com、cloud.tencent.com、新浪、头条、网易新闻、腾讯新闻、51CTO、知乎、果壳科技（移动版）、awesomes.cn、javascriptcn.com、人民日报（移动版）、凤凰网、虎扑移动版、百度经验、360文档（个人图书馆）、乐居买房（移动版）、电子发烧友网（PC、移动版）、悟空问答（PC、移动版）、百家号、百度文章、简书移动版、搜狐移动版、goodreads（PC、移动版）、百度文库(移动、PC版)、36氪移动版
// @author       zhengmingliang
// @updateURL    https://raw.githubusercontent.com/ydx1013/backup/master/阅读全文.js
// @downloadURL   https://raw.githubusercontent.com/ydx1013/backup/master/阅读全文.js
// @match        *://*.github.io/*
// @match        *://*.jianshu.com/p/*
// @match        *://m.sohu.com/a/*
// @match        *://*.xz577.com/*
...
// @include        *://www.wukong.com/question/*
// @include        *://cloud.tencent.com/*
// @include        *://m.leju.com/*
// @include        *://*.didispace.com/*
// @include        *://*.sina.cn/*
// @include        *://*.toutiao.com/*
// @include        *://weibo.com/ttarticle/p/show*
// @include        *://card.weibo.com/article/m/show/id/*
// @include        *://3g.163.com/*
// @include        *://*.*.163.com/news/*
// @include        *://*.inews.qq.com/*
// @include        *://*.36kr.com/p/*
// @include        *://*.elecfans.com/*
// @include        *://inews.qq.com/*
// @include        *://xw.qq.com/*
...
// @include        *://*.guokr.com/*
// @include        *://*.awesomes.cn/*
// @include        *://*.javazhiyin.com/*
// @include        *://m.hupu.com/bbs/*
// @include        *://bugstack.cn/md/*
// @include        *://wap.peopleapp.com/article/*
// @include        *://jingyan.baidu.com/article/*
// @include        *://*.ifeng.com/c/*
// @include        *://*.360doc.com/content/*
// @include        *://www.hi-linux.com/posts/*
// ==/UserScript==
